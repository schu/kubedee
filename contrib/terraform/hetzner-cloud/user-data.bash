...
curl -fsSL https://github.com/cloudflare/cfssl/releases/download/v1.5.0/cfssl_1.5.0_linux_amd64 -o /tmp/cfssl &&
  install -m 0755 /tmp/cfssl /usr/local/bin/
curl -fsSL https://github.com/cloudflare/cfssl/releases/download/v1.5.0/cfssljson_1.5.0_linux_amd64 -o /tmp/cfssljson &&
